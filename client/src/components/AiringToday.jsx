...
import { getAiringToday } from '../features/series/serieSlice';

function AiringToday() {
    const data = useSelector((state) => state.series.airingToday);
    ...
    return (
        <section className="carousel-section">
            <h1 className="carousel-header">Shows Airing Today</h1>
